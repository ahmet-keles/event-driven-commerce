...
import com.ahmetkeles.paymentservice.outbox.OutboxPublisher;
 ...
 * {@link com.ahmetkeles.paymentservice.outbox.OutboxPublisherConcurrencyIntegrationTest};
...
class PaymentOutboxPublisherTest {
    ...
    void successfulPublishMarksEventPublished() {
        ...
        OutboxEvent event = event(UUID.randomUUID(), "PAYMENT_COMPLETED");
    ...
    void failedEventBlocksLaterEventsForTheSameAggregate() {
        ...
        OutboxEvent first = event(aggregateId, "PAYMENT_COMPLETED");
        OutboxEvent second = event(aggregateId, "PAYMENT_FAILED");
    ...
    void failedAggregateDoesNotBlockOtherAggregates() {
        ...
        OutboxEvent failing = event(failingAggregate, "PAYMENT_COMPLETED");
        OutboxEvent healthy = event(healthyAggregate, "PAYMENT_COMPLETED");
    ...
    void aggregateWhoseOldestEventIsHeldElsewhereIsDeferred() {
        ...
        OutboxEvent laterEvent =
                event(contestedAggregate, "PAYMENT_FAILED");
