...
import com.ahmetkeles.orderservice.messaging.InvalidEventException;
...
public class KafkaErrorHandlingConfig {
    ...
    /** Dead-letter topic name for a source topic, e.g. {@code inventory.events.DLT}. */
    ...
    /**
     * Dead-letter topic for the inventory events this service consumes. Guarded
     * by the same property as the other topic definitions so tests that run
     * without a broker do not attempt topic creation.
     */
    @Bean
    ...
    org.apache.kafka.clients.admin.NewTopic inventoryEventsDeadLetterTopic(
